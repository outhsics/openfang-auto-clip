...
This repository now keeps English and Chinese documentation in paired files where possible.

## Core entry points

- [README.md](README.md): Chinese project overview
- [README_EN.md](README_EN.md): English project overview
- [docs-site/index.html](docs-site/index.html): English landing page
- [docs-site/zh/index.html](docs-site/zh/index.html): Chinese landing page

## Root guides

- [CHANGELOG.md](CHANGELOG.md) / [CHANGELOG_ZH.md](CHANGELOG_ZH.md)
- [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md)
- [CONTRIBUTING.md](CONTRIBUTING.md) / [CONTRIBUTING_ZH.md](CONTRIBUTING_ZH.md)
- [DISCLAIMER.md](DISCLAIMER.md)
- [GITHUB_RELEASE_NOTES.md](GITHUB_RELEASE_NOTES.md) / [GITHUB_RELEASE_NOTES_ZH.md](GITHUB_RELEASE_NOTES_ZH.md)
- [OPEN_SOURCE_PLAN.md](OPEN_SOURCE_PLAN.md)
- [PROJECT_STATUS.md](PROJECT_STATUS.md)
- [PROJECT_SUMMARY.md](PROJECT_SUMMARY.md) / [PROJECT_SUMMARY_ZH.md](PROJECT_SUMMARY_ZH.md)
...
- [IP_PROTECTION.md](IP_PROTECTION.md) / [IP_PROTECTION_EN.md](IP_PROTECTION_EN.md)
- [NEXT_STEPS.md](NEXT_STEPS.md) / [NEXT_STEPS_EN.md](NEXT_STEPS_EN.md)
- [TRANSFORM_EFFECTS.md](TRANSFORM_EFFECTS.md) / [TRANSFORM_EFFECTS_EN.md](TRANSFORM_EFFECTS_EN.md)
- [WEB_MANAGER_README.md](WEB_MANAGER_README.md) / [WEB_MANAGER_README_EN.md](WEB_MANAGER_README_EN.md)
- [🎉_READY_TO_PUBLISH.md](🎉_READY_TO_PUBLISH.md) / [READY_TO_PUBLISH_EN.md](READY_TO_PUBLISH_EN.md)
...
- The paired files aim to preserve the same operational guidance, not necessarily line-for-line translation.
- README and the landing page remain the highest-priority onboarding surfaces and should be updated first when the product changes.
