...
- Inspect the committed local-evaluation snapshot in [examples/evaluation/sample_local_evaluation_report.md](examples/evaluation/sample_local_evaluation_report.md)
