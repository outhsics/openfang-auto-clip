...
仓库里的核心文档现在按中英文配对维护，便于对外发布和团队内部协作。

## 核心入口

- [README.md](README.md)：中文版项目总览
- [README_EN.md](README_EN.md)：英文版项目总览
- [docs-site/index.html](docs-site/index.html)：英文 landing page
- [docs-site/zh/index.html](docs-site/zh/index.html)：中文 landing page
...
- 成对文档追求信息等价，不强求逐字对应。
- 当产品能力变化时，优先更新 README 和 landing page，再同步扩散到细分文档。
